                ...
                <div class="card-body">
                    ...
                    <div class="mt-1">
                        <div class="d-flex align-items-center gap-3">
                            <h3 class="mb-0">62%</h3>
                            <p class="mb-0 text-muted">Your sales performance is 35% 😎 better
                    ...
                    <ul class="p-0 m-0">
                        <li class="d-flex pb-1 mb-3">
                            <div class="flex-shrink-0">
                                <img src="<?= base_url(); ?>assets/img/icons/brands/facebook-rounded.png" alt="facebook"
                        ...
                        <li class="d-flex pb-1 mb-3">
                            <div class="flex-shrink-0">
                                <img src="<?= base_url(); ?>assets/img/icons/brands/dribbble-rounded.png" alt="dribbble"
                                    class="me-3" height="34" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex pb-1 mb-3">
                            <div class="flex-shrink-0">
                                <img src="<?= base_url(); ?>assets/img/icons/brands/twitter-rounded.png" alt="facebook"
                                    class="me-3" height="34" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex pb-1">
                            <div class="flex-shrink-0">
                                <img src="<?= base_url(); ?>assets/img/icons/brands/instagram-rounded.png"
                                    alt="instagram" class="me-3" height="34" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <p class="mb-0 text-muted">
                            Last month you had $2.42 expense transactions, 12 savings entries and 4
                            bills.
                        </p>
                    </div>
                </div>
                    ...
                    <ul class="p-0 m-0">
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <img src="<?= base_url(); ?>assets/img/avatars/4.png" alt="avatar" class="rounded" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <img src="<?= base_url(); ?>assets/img/avatars/5.png" alt="avatar" class="rounded" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <img src="<?= base_url(); ?>assets/img/avatars/3.png" alt="avatar" class="rounded" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <img src="<?= base_url(); ?>assets/img/avatars/14.png" alt="avatar" class="rounded" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <img src="<?= base_url(); ?>assets/img/avatars/8.png" alt="avatar" class="rounded" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex">
                            <div class="avatar flex-shrink-0 me-3">
                                <img src="<?= base_url(); ?>assets/img/avatars/1.png" alt="avatar" class="rounded" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                    ...
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                ...
                                <th class="text-end text-capitalize text-body fw-medium fs-6">Spend
                                </th>
                            </tr>
                        </thead>
                        <tbody class="border-top">
                            <tr>
                                <td class="d-flex">
                                    <div class="px-2 rounded bg-lighter d-flex align-items-center h-px-30">
                                        <img src="<?= base_url(); ?>assets//img/icons/payments/logo-visa.png"
                            ...
                            <tr>
                                <td class="d-flex">
                                    <div class="px-2 rounded bg-lighter d-flex align-items-center h-px-30">
                                        <img src="<?= base_url(); ?>assets//img/icons/payments/logo-mastercard.png"
                            ...
                            <tr>
                                <td class="d-flex">
                                    <div class="px-2 rounded bg-lighter d-flex align-items-center h-px-30">
                                        <img src="<?= base_url(); ?>assets//img/icons/payments/logo-american-express.png"
