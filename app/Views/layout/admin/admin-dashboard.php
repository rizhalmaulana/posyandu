                ...
                <div class="row">
                    ...
                    <div class="col-6 text-end d-flex align-items-end justify-content-center">
                        <div class="card-body pb-0 pt-3 position-absolute bottom-0">
                            <img src="<?= base_url(); ?>assets/img/illustrations/card-ratings-illustration.png"
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card h-100">
                <div class="row">
                    ...
                    <div class="col-6 text-end d-flex align-items-end justify-content-center">
                        <div class="card-body pb-0 pt-3 position-absolute bottom-0">
                            <img src="<?= base_url(); ?>assets/img/illustrations/card-session-illustration.png"
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1">
                                    <h6 class="text-white mt-0 mt-md-3 mb-3 py-1">Mobiles &
                                        Computers</h6>
                                    <div class="row">
                                        <div class="col-6">
                                ...
                                <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                                    <img src="<?= base_url(); ?>assets/img/products/card-weekly-sales-phone.png"
                    ...
                    <div class="swiper-slide">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1">
                                <h6 class="text-white mt-0 mt-md-3 mb-3 py-1">Appliances &
                                    Electronics</h6>
                                <div class="row">
                                    <div class="col-6">
                                        <ul class="list-unstyled mb-0">
                                            <li class="d-flex mb-3 align-items-center">
                                                <p class="mb-0 me-2 weekly-sales-text-bg-primary">16
                                                </p>
                                                <p class="mb-0">TV's</p>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <p class="mb-0 me-2 weekly-sales-text-bg-primary">40
                                                </p>
                                    ...
                                    <div class="col-6">
                                        <ul class="list-unstyled mb-0">
                                            <li class="d-flex mb-3 align-items-center">
                                                <p class="mb-0 me-2 weekly-sales-text-bg-primary">9
                                                </p>
                                                <p class="mb-0">Cameras</p>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <p class="mb-0 me-2 weekly-sales-text-bg-primary">18
                                                </p>
                            ...
                            <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                                <img src="<?= base_url(); ?>assets/img/products/card-weekly-sales-controller.png"
                                    alt="weekly sales" width="230" class="weekly-sales-img" />
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li class="d-flex align-items-center">
                                                <p class="mb-0 me-2 weekly-sales-text-bg-primary">29
                                                </p>
                                    ...
                                    <div class="col-6">
                                        <ul class="list-unstyled mb-0">
                                            <li class="d-flex mb-3 align-items-center">
                                                <p class="mb-0 me-2 weekly-sales-text-bg-primary">43
                                                </p>
                                                <p class="mb-0">Shoes</p>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <p class="mb-0 me-2 weekly-sales-text-bg-primary">7
                                                </p>
                            ...
                            <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                                <img src="<?= base_url(); ?>assets/img/products/card-weekly-sales-watch.png"
                                    alt="weekly sales" width="230" class="weekly-sales-img" />
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="timeline card-timeline mb-0">
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                ...
                                <p class="text-muted mb-2">Invoices have been paid to the company
                                </p>
                                <div class="d-flex">
                                    <a href="javascript:void(0)" class="me-3">
                                        <img src="<?= base_url(); ?>assets/img/icons/misc/pdf.png" alt="PDF image"
                                            width="15" class="me-2" />
                            ...
                            <div class="timeline-event">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    <div class="avatar avatar-sm me-3">
                                        <img src="<?= base_url(); ?>assets/img/avatars/1.png" alt="Avatar"
                        ...
                        <li class="timeline-item timeline-item-transparent border-0">
                            ...
                            <div class="timeline-event pb-1">
                                ...
                                <p class="text-muted mb-0">Invoices have been paid to the company.
                                </p>
                            </div>
                        </li>
                    </ul>
                                ...
                                <table class="table table-borderless">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="fw-medium ps-0 text-heading">Product Name
                                            </th>
                                            <th class="pe-0 fw-medium text-end text-heading">Status
                                            </th>
                                            <th class="pe-0 fw-medium text-end text-heading">Revenue
                                            </th>
                                            <th class="pe-0 text-end fw-medium text-heading">
                                                Conversion</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="ps-0">
                                                <img src="<?= base_url(); ?>assets//img/products/samsung-s22.png"
                                                    alt="samsung" class="rounded" height="34" />
                                            </td>
                                            <td class="text-heading fw-semibold ps-0">Oneplus 9 Pro
                                            </td>
                                            <td class="text-heading text-end pe-0">
                                                <span class="badge rounded-pill bg-label-primary">Out
                                                    of Stock</span>
                                            </td>
                                            <td class="text-heading text-end pe-0 fw-semibold">
                                                $12.5k</td>
                                            <td class="pe-0 text-end fw-semibold h6 text-success">
                                                +24%</td>
                                        </tr>
                                        <tr>
                                            <td class="ps-0">
                                                <img src="<?= base_url(); ?>assets//img/products/apple-iPhone-13-pro.png"
                                                    alt="iphone" class="rounded" height="34" />
                                            </td>
                                            <td class="text-heading fw-semibold ps-0">Apple iPhone
                                                13 Pro</td>
                                            <td class="text-heading text-end pe-0">
                                                <span class="badge rounded-pill bg-label-success">In
                                                    Stock</span>
                                            </td>
                                            <td class="text-heading text-end pe-0 fw-semibold">$45k
                                            </td>
                                            <td class="pe-0 text-end fw-semibold h6 text-danger">
                                                -18%</td>
                                        </tr>
                                        <tr>
                                            <td class="ps-0">
                                                <img src="<?= base_url(); ?>assets//img/products/oneplus-9-pro.png"
                                                    alt="us-flag" class="rounded" height="34" />
                                            </td>
                                            <td class="text-heading fw-semibold ps-0">Oneplus 9 Pro
                                            </td>
                                            <td class="text-heading text-end pe-0">
                                                <span class="badge rounded-pill bg-label-warning">Coming
                                                    Soon</span>
                                            </td>
                                            <td class="text-heading text-end pe-0 fw-semibold text-heading">
                                                $98.2k</td>
                                            <td class="pe-0 text-end fw-semibold h6 text-success">
                                                +55%</td>
                                        </tr>
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="ps-0">
                                                <img src="<?= base_url(); ?>assets//img/products/apple-mac-mini.png"
                                                    alt="mac-mini" class="rounded" height="34" />
                                            </td>
                                            <td class="text-heading fw-semibold ps-0">Apple Mac Mini
                                            </td>
                                            <td class="text-heading text-end pe-0">
                                                <span class="badge rounded-pill bg-label-success">In
                                                    Stock</span>
                                        ...
                                        <tr>
                                            <td class="ps-0">
                                                <img src="<?= base_url(); ?>assets//img/products/hp-envy-x360.png"
                                                    alt="hp-envy" class="rounded" height="34" />
                                            </td>
                                            <td class="text-heading fw-semibold ps-0">Newest HP Envy
                                                x360</td>
                                            <td class="text-heading text-end pe-0">
                                                <span class="badge rounded-pill bg-label-warning">Coming
                                                    Soon</span>
                                        ...
                                        <tr>
                                            <td class="ps-0">
                                                <img src="<?= base_url(); ?>assets//img/products/dell-inspiron-3000.png"
                                                    alt="dell" class="rounded" height="34" />
                                            </td>
                                            <td class="text-heading fw-semibold ps-0">Dell Inspiron
                                                3000</td>
                                            <td class="text-heading text-end pe-0">
                                                <span class="badge rounded-pill bg-label-primary">Out
                                                    of Stock</span>
                                            ...
                                            <td class="text-heading text-end pe-0 fw-semibold">
                                                $69.3k</td>
                                            <td class="pe-0 text-end fw-semibold h6 text-danger">-9%
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="ps-0">
                                                <img src="<?= base_url(); ?>assets//img/products/sony-play-station-5.png"
                                                    alt="sony-play-station" class="rounded" height="34" />
                                            </td>
                                            <td class="text-heading fw-semibold ps-0">Sony Play
                                                Station 5</td>
                                            <td class="text-heading text-end pe-0">
                                                <span class="badge rounded-pill bg-label-warning">Coming
                                                    Soon</span>
                                        ...
                                        <tr>
                                            <td class="ps-0">
                                                <img src="<?= base_url(); ?>assets//img/products/xbox-series-x.png"
                                                    alt="xbox" class="rounded" height="34" />
                                            </td>
                                            <td class="text-heading fw-semibold ps-0">XBOX Series X
                                            </td>
                                            <td class="text-heading text-end pe-0">
                                                <span class="badge rounded-pill bg-label-primary">Out
                                                    of Stock</span>
                                        ...
                                        <tr>
                                            <td class="ps-0">
                                                <img src="<?= base_url(); ?>assets//img/products/nintendo-switch.png"
                                                    alt="nintendo-switch" class="rounded" height="34" />
                                            </td>
                                            <td class="text-heading fw-semibold ps-0">Nintendo
                                                Switch</td>
                                            <td class="text-heading text-end pe-0">
                                                <span class="badge rounded-pill bg-label-success">In
                                                    Stock</span>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide pb-3">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            <img src="<?= base_url(); ?>assets//img/products/card-marketing-expense-logo.png"
                    ...
                    <div class="swiper-slide pb-3">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            <img src="<?= base_url(); ?>assets//img/products/card-accounting-logo.png"
                                alt="Marketing and sales" width="84" class="rounded" />
                            <div class="d-flex flex-column w-100 ms-4">
                    ...
                    <div class="swiper-slide pb-3">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            <img src="<?= base_url(); ?>assets//img/products/card-sales-overview-logo.png"
                                alt="Marketing and sales" width="84" class="rounded" />
                            <div class="d-flex flex-column w-100 ms-4">
