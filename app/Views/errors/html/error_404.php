...
<body>
    ...
    <div class="misc-wrapper">
        ...
        <h4 class="mb-2 fw-semibold">Halaman tidak ditemukan ⚠️</h4>
        <p class="mb-4 mx-2">kami tidak dapat menemukan halaman yang Anda cari</p>
        <div class="d-flex justify-content-center mt-5">
            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <div>
                    <a href="<?= previous_url(); ?>" class="btn btn-primary text-center my-4">Kembali</a>
                </div>
            </div>
        </div>
    </div>
