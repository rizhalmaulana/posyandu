...
<head>
    ...
    <link rel="stylesheet"
        href="<?= base_url('assets/vendor/libs/bootstrap-datepicker/bootstrap-datepicker.css'); ?>" />
                                        ...
                                        <a class="dropdown-item" href="pages-account-settings-account.html">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span
                                                        class="fw-semibold d-block"><?= $session['nama_lengkap']; ?></span>
                            ...
                            <ul class="menu-inner">
                                    ...
                                    <ul class="menu-sub">
                                        <li class="menu-item <?= $active_submenu_monitoring; ?>">
                                            <a href="<?= base_url('dashboard') ?>" class="menu-link">
                                                ...
                                                <div data-i18n="Master Dashboard">Master Dashboard</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="menu-item">
                                    <a href="javascript:void(0)" class="menu-link menu-toggle">
                                        ...
                                        <div data-i18n="Menu">Menu Keseluruhan</div>
                                    </a>
                                    <ul class="menu-sub">
                                        <li class="menu-item">
                                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                            ...
                                            <ul class="menu-sub">
                                                <li class="menu-item">
                                                    <a href="<?= base_url('dashboard/data-balita'); ?>"
                                                        class="menu-link">
                                                ...
                                                <li class="menu-item">
                                                    <a href="<?= base_url('dashboard/data-balita'); ?>"
                                                        class="menu-link">
                                                        <i class="menu-icon tf-icons mdi mdi-circle-medium"></i>
                                                        <div data-i18n="Data Kunjungan Balita">Data Kunjungan Balita</div>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="menu-item">
                                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                                <i class="menu-icon tf-icons mdi mdi-card-account-details-outline"></i>
                                                <div data-i18n="Master Posyandu">Master Posyandu</div>
                                            </a>
                                            <ul class="menu-sub">
                                                <li class="menu-item">
                                                    <a href="<?= base_url('dashboard/data-balita'); ?>"
                                                        class="menu-link">
                                                        <i class="menu-icon tf-icons mdi mdi-circle-medium"></i>
                                                        <div data-i18n="Data Posyandu">Data Posyandu</div>
                                                    </a>
                                                </li>
                                                <li class="menu-item">
                                                    <a href="<?= base_url('dashboard/data-balita'); ?>"
                                                        class="menu-link">
                                                        <i class="menu-icon tf-icons mdi mdi-circle-medium"></i>
                                                        <div data-i18n="Data Kader Posyandu">Data Kader Posyandu</div>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="menu-item <?= $active_menu_mastergizi; ?>">
                                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                                ...
                                                <div data-i18n="Master Data & Informasi">Master Data & Informasi</div>
                                            </a>
                                            <ul class="menu-sub">
                                                <li class="menu-item" <?= $active_submenu_statusgizi; ?>>
                                                    <a href="<?= base_url('dashboard/rekap-pemeriksaan'); ?>"
                                                        class="menu-link">
                                                        <i class="menu-icon tf-icons mdi mdi-circle-medium"></i>
                                                        <div data-i18n="Tambah Data Posyandu">Tambah Data Posyandu</div>
                                                    </a>
                                                </li>
                                                <li class="menu-item" <?= $active_submenu_statusgizi; ?>>
                                                    <a href="<?= base_url('dashboard/rekap-pemeriksaan'); ?>"
                                                        class="menu-link">
                                                        <i class="menu-icon tf-icons mdi mdi-circle-medium"></i>
                                                        <div data-i18n="Tambah Data Kader">Tambah Data Pengguna</div>
                                                    </a>
                                                </li>
                                                <li class="menu-item" <?= $active_submenu_statusgizi; ?>>
                                                    <a href="<?= base_url('dashboard/rekap-pemeriksaan'); ?>"
                                                        class="menu-link">
                                                        <i class="menu-icon tf-icons mdi mdi-circle-medium"></i>
                                                        <div data-i18n="Tambah Data Berita">Tambah Data Berita</div>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
